...
def add_user():
    ...
    #sers.append({"name":zmienna_imie, "surname":zmienna_nazwisko, "location":zmienna_miejscowosc, "post":zmienna_posty})
    print(users)
...
button_edytuj_obiekt = Button(ramka_lista_obiektow,text = "Edytuj obiekt", command=update_users)
